...
public class CustomerInfoController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Customers> findAssociatedCustomerses(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated customerses");
        return customerInfoService.findAssociatedCustomerses(id, pageable);
    }
