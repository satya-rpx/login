...
import com.login.dbloan.service.Table7Service;
...
public class Table7Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table7 getTable7(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table7 editTable7(@PathVariable("id") Integer id, @RequestBody Table7 table7) {
    ...
    @ApiOperation(value = "Partially updates the Table7 instance associated with the given id.")
    @RequestMapping(value = "/{id:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Table7 patchTable7(@PathVariable("id") Integer id, @RequestBody @MapTo(Table7.class) Map<String, Object> table7Patch) {
        LOGGER.debug("Partially updating Table7 with id: {}" , id);

        Table7 table7 = table7Service.partialUpdate(id, table7Patch);
        LOGGER.debug("Table7 details after partial update: {}" , table7);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTable7(@PathVariable("id") Integer id) {
    ...
    public Page<Table7> searchTable7sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Table7s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<Table7> findTable7s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering Table7s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @XssDisable
    public StringWrapper exportTable7sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = Table7.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> table7Service.export(exportOptions, pageable, outputStream));
