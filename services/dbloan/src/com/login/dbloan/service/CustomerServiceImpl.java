 ...
 * @see Customer
 */
@Service("dbloan.CustomerService")
@Validated
public class CustomerServiceImpl implements CustomerService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbloan for table Customer to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbloan for table Customer to {} format", options.getExportType());
