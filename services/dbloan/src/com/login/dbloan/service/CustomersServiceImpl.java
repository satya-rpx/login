 ...
 * @see Customers
 */
@Service("dbloan.CustomersService")
@Validated
public class CustomersServiceImpl implements CustomersService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbloan for table Customers to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbloan for table Customers to {} format", options.getExportType());
